...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json('response', compact(['categoriesPostCount', 'popular', 'posts', 'title']));
    }
    ...
    public function show($slug)
    {
        ...
        return response()->json('response', compact(['post', 'categoriesPostCount', 'popular', 'post_categories', 'userRating', 'postRating', 'comments']));
    }
