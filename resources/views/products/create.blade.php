    ...
    <div class="ibox-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="form-group mb-4">
                        <label>Details</label>
                        {{ Form::textarea('details', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Short Description', 'rows' => 3]) }}
                        @error('details')
                    ...
                    <div class="form-group mb-4">
                        ...
                        {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Description', 'id' => 'summernote']) }}
                        @error('description')
