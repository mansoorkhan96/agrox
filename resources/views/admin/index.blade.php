        ...
        <div class="ibox ibox-fullheight">
            ...
            <div class="ibox-body">
                <ul class="media-list media-list-divider mr-2 scroller" data-height="480px">
                    @forelse ($newCustomers as $item)
                    <li class="media align-items-center">
                        <a class="media-img" href="{{ route('profile.show', $item->id) }}">
                            <img class="img-circle" src="{{ avatar($item->avatar) }}" alt="image" width="54" />
                        </a>
                        <div class="media-body d-flex align-items-center">
                            <div class="flex-1">
                                <div class="media-heading">{{ $item->name }}</div>
                                <small class="text-muted">{{ Str::limit($item->details, 20) }}</small></div>
                        </div>
                    </li>
                    @empty
                        <p class="lead">No new Customers</p>
                    @endforelse
                </ul>
            </div>
        </div>
